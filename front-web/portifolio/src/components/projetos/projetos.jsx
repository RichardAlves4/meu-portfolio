...
const arrayProjects = [
  ...
  },
  {
    ...
    resumo: "PIM é um projeto em equipe multidisciplinar da Unip para atribuir uma porcentagem na média de todas as matérias e que também é avaliado separadamente como uma matéria.",
    introducao: "A proposta do PIM era criar um sistema acadêmico que permitisse gerenciar turmas, alunos e aulas, além de que os dados gerados deveriam ser persistentes.",
    objetivo:"Outro objetivo desse projeto era reduzir o desperdício de materiais e principalmente o do papel, tendo em vista que o sistema seria desenvolvido para uma instituição que fazia tudo manualmente. Por isso eu e minha equipe focamos em tornar esse sistema o mais completo possível usando as tecnologias designadas pelo projeto.",
    front: "TKinter(nativo python), CustomTKinter(biblioteca).",
    back: "Python, C.",
    dados: "Arquivos .json e pdf.",
    observacoes: "No final, o projeto acabou sendo mais extenso do que complexo, pois as tecnologias e conceitos que podíamos usar eram básicos. Como eu já tinha familiaridade com boa parte do que foi usado no projeto, eu não consegui aprender muito além do que já sabia. Para mim, o que eu mais aprendi nesse projeto foi sobre gerenciar/liderar uma equipe de desenvolvimento, pois eu acabei tendo que exercer o papel de \"Scrum Master e Product Owner\" ao mesmo tempo.",
